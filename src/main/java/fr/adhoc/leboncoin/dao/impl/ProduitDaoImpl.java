...
public class ProduitDaoImpl implements ProduitDao {
	...
	@Override
	public Produit create(Utilisateur vendeur){
		
		
		//Creation d'une instance de produit
		Produit myProduit = new Produit(vendeur);
        try{		
        ...
        String str = "INSERT INTO Produit (NOM,PRIXDEPART,DESCRIPTION,V_ID) VALUES ('" + 
        								myProduit.getNom() + "'," + 
        								myProduit.getPrixDepart() + ",'" + 
        								myProduit.getDescription() + "'," +
        								myProduit.getVendeur() + ")";
        stmt.execute(str);
        return myProduit;
        }
